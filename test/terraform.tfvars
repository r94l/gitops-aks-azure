...
gitops_repo_url  = "https://github.com/r94l/gitops-aks-azure-configs" # GitOps repository for infrastructure configs (reference only)
argocd_namespace = "argocd"                                          # Namespace where ArgoCD will be deployed

# Application Deployment Configuration 
app_repo_url  = "https://github.com/r94l/gitops-aks-azure-configs" # Repository containing your application manifests
